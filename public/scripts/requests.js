...
const postNewGame = async form => {
  ...
  try {
    const response = await postData('/games', object)
...
const postNewCategory = async form => {
  const object = prepareFormData(form)
  try {
    const response = await postData('/categories', object)
    if (response instanceof Error) {
      throw new Error(response.message)
    }
    return response
...
const postNewUser = async form => {
  const object = prepareFormData(form)
  try {
    const response = await postData('/users', object)
    if (response instanceof Error) {
      throw new Error(response.message)
    }
    return response
...
const deleteGame = async id => {
  const response = await deleteData(`/games/${id}`)
  return response
}
...
const putGame = async id => {
  try {
    const response = await putData(`/games/${id}`, currentState)
    if (response instanceof Error) {
      throw new Error(response.message)
    }
    return response
...
const putCategory = async id => {
  try {
    const response = await putData(`/categories/${id}`, currentCategoryState)
    if (response instanceof Error) {
      throw new Error(response.message)
    }
    return response
...
const putUser = async id => {
  try {
    const response = await putData(`/users/${id}`, userCurrentState)
    if (response instanceof Error) {
      throw new Error(response.message)
    }
    return response
